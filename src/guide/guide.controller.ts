...
export class GuideController {
  ...
  @ApiOperation({
    summary: '가이드 화면 조회',
    description:
      '패턴 기반, 장 건강, 주의 신호 섹션을 반환합니다. 주간 통합 기록이 3일 미만이면 패턴 가이드만 빈 배열로 반환하고 장 건강/주의 신호 가이드는 모두 반환합니다. 장 건강 및 주의 신호 가이드는 사용자 기록이나 패턴 감지 여부와 관계없이 모든 활성 가이드를 반환합니다.',
  })
  ...
  @ApiOperation({
    summary: '가이드 상세 조회',
    description:
      'guideId로 가이드 기본 정보와 순서가 보장된 상세 본문을 조회합니다. 장 건강(H)은 다른 활성 장 건강 가이드를 추천하고, 패턴(P)은 KST 현재 주의 기록 상태와 감지 근거를 반환합니다. 주의 신호(W)는 DB에 저장된 정적 가이드 본문과 조언을 반환합니다.',
  })
